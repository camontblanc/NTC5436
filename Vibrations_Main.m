...
% Estimación de la densidad espectral de potencia de Welch. En el caso 
...
% Ponderación de la densidad espectral por medio de las magnitudes de las
% funciones de transferencia en dB. Es decir, densidad espectral de
% potencia de la señal ponderada.
weighPSD = ISOseatVER(Y,f);

% Cálculo de la aceleración rms en el dominio de la frecuencia.
